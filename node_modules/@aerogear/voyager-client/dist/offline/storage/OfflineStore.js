...
var OfflineStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.storage.setItem(this.getOfflineKey(entry.id), entry.toOfflineItem())];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        offlineKey = this.getOfflineKey(entry.id);
    ...
    OfflineStore.prototype.getOfflineData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var offlineItems, _i, _a, key, item;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        key = _a[_i];
                        return [4 /*yield*/, this.storage.getItem(this.getOfflineKey(key))];
                    case 2:
                        item = _b.sent();
